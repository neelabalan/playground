...
app.layout = html.Div(
    [
        ...
        dash_table.DataTable(
            id='table',
            columns=[{'name': i, 'id': i} for i in ['Coin', 'Price', 'Market Cap', '24h Volume', '24h Change']],
            data=[],
            export_format='csv',
        ),
    ]
...
def update_price(children, value):
    ...
    return currency_symbol_map.get(value) + str(cg.get_price(ids='bitcoin', vs_currencies=value)['bitcoin'][value])
